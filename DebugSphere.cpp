...
void DebugSphere::Create(float Radius, int Resolution)
{
    double PI = 3.14159;
    ...
    for (int w = 0; w < Resolution; w++) {
        for (int h = (-Resolution / 2); h < (Resolution / 2); h++) {
           ...
           // so you probably want to write your own algorithm for this!
            t.push_back(glm::vec2(0.6666f, 0.5f) * glm::vec2(1, 0.25f) + glm::vec2(0, 0.25f * 3));
            t.push_back(glm::vec2(0.666f, 1.0f) * glm::vec2(1, 0.25f) + glm::vec2(0, 0.25f * 3));
            t.push_back(glm::vec2(1.0f, 1.0f) * glm::vec2(1, 0.25f) + glm::vec2(0, 0.25f * 3));

            t.push_back(glm::vec2(0.6666f, 0.5f) * glm::vec2(1, 0.25f) + glm::vec2(0, 0.25f * 3));
            t.push_back(glm::vec2(1.00f, 1.0f) * glm::vec2(1, 0.25f) + glm::vec2(0, 0.25f * 3));
            t.push_back(glm::vec2(1.00f, 0.5f) * glm::vec2(1, 0.25f) + glm::vec2(0, 0.25f * 3));
